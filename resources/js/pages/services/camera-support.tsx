...
const serviceNav = [
    ...
    { labelKey: 'services.nav.camera', href: '/services/camera-support', active: true },
...
function HeroSection() {
    ...
    return (
        <section className="relative z-10 flex min-h-screen flex-col items-center justify-center overflow-hidden bg-[#000168]">
            ...
            >
                <img
                    src="/assets/images/camera-support.png"
            ...
            >
                ...
                >
                    {t('services.hero.label')} / {t('services.nav.camera')}
                </motion.p>
...
export default function CameraSupport() {
    ...
    return (
        <GuestLayout hideFooter>
            <Head title={t('services.camera.pageTitle')}>
                <meta
                    head-key="description"
                    name="description"
                    content={t('services.camera.pageDescription')}
                />
            </Head>
                        ...
                        <div className="mx-auto flex h-screen max-w-5xl flex-col items-center justify-center text-center text-base text-[#000168] md:text-2xl">
                            <motion.p
                                ...
                                dangerouslySetInnerHTML={{
                                    __html: t('services.camera.introP1'),
                                }}
                            />
                            <motion.p
                                variants={fadeUp}
                                ...
                                dangerouslySetInnerHTML={{
                                    __html: t('services.camera.introP2'),
                                }}
                            />
                        </div>
                    </motion.div>
