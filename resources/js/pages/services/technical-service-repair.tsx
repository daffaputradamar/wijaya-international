...
const serviceNav = [
    ...
    { labelKey: 'services.nav.technical', href: '/services/technical-service-repair', active: true },
] as const;
...
function HeroSection() {
    ...
    return (
        <section className="relative z-10 flex min-h-screen flex-col items-center justify-center overflow-hidden bg-[#000168]">
            ...
            >
                <img
                    src="/assets/images/technical-service.png"
            ...
            >
                ...
                >
                    {t('services.hero.label')} / {t('services.nav.technical')}
                </motion.p>
                <h1 className="overflow-hidden text-left text-4xl leading-none font-extrabold tracking-tighter text-white uppercase sm:text-5xl md:text-6xl lg:text-7xl">
                    <span className="mr-[0.2em] inline-block overflow-hidden">
                        ...
                        >
                            {t('services.technical.heroTitle')}
                        </motion.span>
                    </span>
                </h1>
            </motion.div>
...
export default function TechnicalServiceRepair() {
    const { t } = useLanguage();

    return (
        <GuestLayout hideFooter>
            <Head title={t('services.technical.pageTitle')}>
                <meta
                    head-key="description"
                    name="description"
                    content={t('services.technical.pageDescription')}
                />
            </Head>
            ...
            <div className="relative z-0">
                ...
                <section className="sticky top-0 z-10 h-screen px-6 py-12 lg:px-12">
                    ...
                    >
                        <div className="mx-auto flex h-screen max-w-5xl flex-col items-center justify-center text-center text-base text-[#000168] md:text-2xl">
                            <motion.p
                                variants={fadeUp}
                                className="mb-6 leading-relaxed"
                                dangerouslySetInnerHTML={{
                                    __html: t('services.technical.introP1'),
                                }}
                            />
                            <motion.p
                                variants={fadeUp}
                                ...
                                dangerouslySetInnerHTML={{
                                    __html: t('services.technical.introP2'),
                                }}
                            />
                        </div>
                    </motion.div>
                ...
                {/* Section 3: Visual & Audio Solutions */}
                ...
                {/* Section 4: Stability & Ergonomics */}
                        ...
                        <div className="grid w-full items-center gap-6 md:grid-cols-2 md:gap-16">
                            <div>
                                <img
                                    ...
                                    alt="Durability & Freedom"
                                    className="aspect-[5/3] w-full rounded-3xl object-cover object-center"
                                />
                            </div>
                            <div className="flex flex-col gap-6">
                                <motion.p
