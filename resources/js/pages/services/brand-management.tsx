...
const serviceNav = [
    { labelKey: 'services.nav.brand', href: '/services/brand-management', active: true },
    { labelKey: 'services.nav.imaging', href: '/services/imaging-solution', active: false },
...
function HeroSection() {
    ...
    return (
        <section className="relative z-10 flex min-h-screen flex-col items-center justify-center overflow-hidden bg-[#000168]">
            ...
            >
                <img
                    src="/assets/images/brand-management.png"
            ...
            >
                ...
                >
                    {t('services.hero.label')} / {t('services.nav.brand')}
                </motion.p>
...
export default function BrandManagement() {
    ...
    return (
        <GuestLayout hideFooter>
            <Head title={t('services.brand.pageTitle')}>
                <meta head-key="description" name="description" content={t('services.brand.pageDescription')} />
            </Head>
            ...
            <div className="fixed right-0 bottom-0 left-0 z-50 mb-6 hidden md:flex justify-between gap-4 bg-[#000168] py-3 px-5 backdrop-blur-md w-[calc(100%-2rem)] mx-auto rounded-xl">
                <div className="flex items-center gap-6">
                    <button className="flex size-10 items-center justify-center rounded-full bg-red-600 text-white shrink-0">
                        ...
                        {serviceNav.map((item) => (
                            <a
                                ...
                                className={`text-base py-3 font-medium transition-colors ${
                                    item.active ? 'text-red-500' : 'text-white/90 hover:text-white'
                                }`}
                            >
                                {t(item.labelKey)}
                            </a>
                ...
                <button
                    ...
                    className="flex size-10 items-center justify-center rounded-full bg-white/20 text-white shrink-0"
                >
            ...
            <div className="relative z-0">
                ...
                <section id="intro" className="sticky top-0 z-10 h-screen px-6 py-12 lg:px-12">
                    <motion.div
                    ...
                    >
                        <div className="mx-auto h-screen flex flex-col justify-center items-center max-w-5xl text-center text-[#000168] text-base md:text-2xl">
                            <motion.p
                                ...
                                dangerouslySetInnerHTML={{ __html: t('services.brand.introP1') }}
                            />
                            <motion.p
                                variants={fadeUp}
                                className="mb-6 leading-relaxed"
                                dangerouslySetInnerHTML={{ __html: t('services.brand.introP2') }}
                            />
                            <motion.p
                                variants={fadeUp}
                                className="leading-relaxed"
                                dangerouslySetInnerHTML={{ __html: t('services.brand.introP3') }}
                            />
                        </div>
                    </motion.div>
                </section>

                {/* Section 3: Campaign Activation */}
                <section id="campaign" className="sticky top-0 z-20 h-screen">
                    <motion.div
                    ...
                    >
                        <div className="grid w-full items-center gap-12 md:grid-cols-2 md:gap-16">
                            <div className="overflow-hidden rounded-3xl p-6 md:p-24">
                                <img
                                    src="/assets/images/img15.png"
                                    alt="Campaign Activation"
                                    className="h-full w-full object-cover aspect-square rounded-3xl"
                                />
                            </div>
                            <div className="flex flex-col gap-6">
                                <motion.p
                                    variants={fadeUp}
                                    className="text-sm md:text-xl leading-relaxed text-white/80"
                                    dangerouslySetInnerHTML={{ __html: t('services.brand.campaignP1') }}
                                />
                                <motion.p
                                    variants={fadeUp}
                                    className="text-sm md:text-xl leading-relaxed text-white/80"
                                    dangerouslySetInnerHTML={{ __html: t('services.brand.campaignP2') }}
                                />
                            </div>
                        </div>
                    </motion.div>
                ...
                {/* Section 4: Event & Community */}
                <section id="event" className="sticky top-0 z-30 h-screen">
                    <motion.div
                    ...
                    >
                        <div className="grid w-full items-center gap-12 md:grid-cols-2 md:gap-16">
                            <div className="flex flex-col gap-6">
                                <motion.p
                                    variants={fadeUp}
                                    className="text-base md:text-xl leading-relaxed text-gray-700"
                                >
                                    {t('services.brand.eventP1')}
                                </motion.p>
                                <motion.p
                                    variants={fadeUp}
                                    className="text-base md:text-xl leading-relaxed text-gray-700"
                                >
                                    {t('services.brand.eventP2')}
                                </motion.p>
                            </div>
                            <div className="overflow-hidden rounded-3xl">
                                <img
                                    src="/assets/images/img16_cropped.png"
                                    alt="Event & Community"
                ...
                {/* Section 5: Portfolio Experience */}
                <section id="portfolio" className="sticky top-0 z-40 h-screen">
                    <motion.div
                        className="relative mx-auto flex h-screen w-full max-w-screen items-center overflow-hidden rounded-t-4xl bg-white px-8 md:px-16"
                        variants={staggerSlow}
                        initial="hidden"
                        whileInView="visible"
                        viewport={{ once: true, margin: '-80px' }}
                    >
                        <div className="grid w-full items-center gap-12 md:grid-cols-2 md:gap-16">
                            <div className="overflow-hidden flex items-center justify-center">
                                <video
                                    src="/assets/videos/KODAK PIXPRO & DEALER GATHERINGPT Wijaya International dengan bangga telah menyelenggarakan kegi.mp4"
                                    className="h-[240px] md:h-[548px] w-[500px] object-cover rounded-4xl"
                                    autoPlay
                                    loop
                                    muted
                                />
                            ...
                            <div className="flex flex-col gap-6">
                                <motion.p
                                    ...
                                    className="text-base md:text-xl leading-relaxed text-gray-700"
                                >
                                    {t('services.brand.portfolioP1')}
                                </motion.p>
                                <motion.p
                                    variants={fadeUp}
                                    className="text-base md:text-xl leading-relaxed text-gray-700"
                                >
                                    {t('services.brand.portfolioP2')}
                                </motion.p>
                            </div>
                        </div>
                    </motion.div>
