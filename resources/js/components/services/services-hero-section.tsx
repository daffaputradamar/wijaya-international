...
import { EASE } from '@/components/home/motion-variants';
...
export default function ServicesHeroSection() {
    ...
    const heroWords = [
        t('services.hero.word1'),
        t('services.hero.word2'),
        t('services.hero.word3'),
        t('services.hero.word4'),
    ];
    ...
    return (
        <section className="relative z-10 flex min-h-screen flex-col items-center justify-center overflow-hidden bg-[#000168]">
            ...
            >
                <video
                    src="/assets/videos/mixkit-digital-animation-of-screens-4192-full-hd.mp4"
                    autoPlay
                    loop
                    muted
                    playsInline
                ...
                <div
                    ...
                    style={{
                        backgroundImage:
                            'linear-gradient(to right, rgba(0, 2, 104, 0.9), rgba(0, 0, 0, 0.5), rgba(0, 3, 139, 0.7))',
                    }}
                />
                <div
                    className="absolute inset-0 rounded-4xl"
